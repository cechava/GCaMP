...
colorCode=[255 0 0;255 0 0;255 0 0;255 0 0;255 0 0;...
    255 127 0;255 127 0;255 127 0;255 127 0;255 127 0;...
    127 255 100;127 255 100;127 255 100;127 255 100;127 255 100;...
...
imwrite(uint8(codedImg),[outDir,'colorCodedElevationMap_tresh',num2str(thresh),'.tif'],'TIFF')

figure;imshow(uint8(legend))
imwrite(uint8(legend),[outDir,'colorCodeElevationLegend.tif'],'TIFF')
