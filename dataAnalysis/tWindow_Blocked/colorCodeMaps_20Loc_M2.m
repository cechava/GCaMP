...
for c=1:nCond
    mapFile=[resultsDir,sessID,'_condition',num2str(c),'_map.mat'];
    load(mapFile);
...
% colorCode=[255 0 0;153 0 0;153 0 77;204 0 77;77 0 0;...
%     255 77 0;153 77 0;77 77 0; 255 204 0;255 204 77;...
%     0 255 0;77 204 0; 153 255 0; ];

colorCode=[255 0 0;255 0 127;127 0 127;127 0 255;0 0 255;...
    255 85 0;255 85 127;127 85 127;127 85 255;0 85 255;...
    255 190 0;255 128 127;127 190 127;127 128 255;0 190 255;...
