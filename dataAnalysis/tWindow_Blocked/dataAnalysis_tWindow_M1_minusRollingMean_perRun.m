function dataAnalysis_tWindow_M1_minusRollingMean_perRun(projectID,sessID,run,tWindow1Start_ASO,tWindow1End_ASO,tWindow2Start_ASO,tWindow2End_ASO)
...
outDir=[analysisFolder,'Analysis_tWindow_M1_minusRollingMean_dsFactor',num2str(dsFactor),'_fwhm',num2str(fwhm),'/MidProcOutput/'];
if isdir(outDir)==0
    mkdir(outDir)
end
...
save(outFile,'respCond','observedResp','tWindow1Start_ASO','tWindow1End_ASO','tWindow2Start_ASO','tWindow2End_ASO');
