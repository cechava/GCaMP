function dataAnalysis_tWindow_M1_detrend2_perRun(run,sessID)
...
outDir=[analysisFolder,'Analysis_tWindow_M1_detrend2_dsFactor',num2str(dsFactor),'_fwhm',num2str(fwhm),'/MidProcOutput/'];
if isdir(outDir)==0
    mkdir(outDir)
end
